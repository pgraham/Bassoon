 ...
 * @package Bassoon
 */
class Bassoon_Template_Proxy implements Bassoon_Template {

    /*
     * Bassoon_RemoteServiceInfo instance for which this template generates code
     */
    private $_srvc;
    ...
    public function __toString() {
        ...
        $proxy .= 'var '.$srvcName.'=function(){'.
            'var p=\''.$webPath.'/'.$srvcName.'\';return {';

        $mthdDefs = array();
        foreach ($this->_srvc->getMethods() AS $method) {
            $mthdDefs[] = new Bassoon_Template_ProxyMethod($method);
        }
